...
import 'package:transporto_registravimas/services/auth.dart';
...
class PhoneAuthDataProvider with ChangeNotifier {
  ...
  Future<bool> instantiate(
    ...
    print("phoneauth72 number " +phone);
    _startAuth();
    return true;
  }
  ...
  _startAuth() {
    ...
    print('Phone auth started phone_auth 129');
    print('verifyOTPAndLogin');
